...
void I2C_Initialization(void){
	...
	// Disable I2C
	I2C1->CR1 &= ~I2C_CR1_PE;
	// Enable the analog noise filter, disable the digital noise filter, enable error interrupts, and enable clock stretching
	...
	//	** t_SCLDEL > Min. Data Setup Time = 1000 ns
	//	** t_SCLDEL = (SCLDEL + 1)t_PRESC
	//	** (SCLDEL + 1)t_PRESC > 1000 ns
	//	** SCLDEL > 7
	//	Choose SCLDEL = 8
	...
	//	** t_SDADEL > Min. Data Hold Time = 1250 ns
	//	** t_SDADEL = (SDADEL + 1)t_PRESC
	//	** (SDADEL + 1)t_PRESC > 1250 ns
	//	** SDADEL > 9
	//	Choose SDADEL = 10
	...
	// --------------------------------------------------------
	//	** For TC74A0, default address = 1001000
	// Disable own address
